...
Such a device is significant because 
...
Furthermore, this device also demonstrates that this can be achieved
    within very small device footprints 
...
Since our method is design-by-specification, 
    ...
    namely the polarization of the input and output modes (\fig{wgc_tm}).
...
\subsection{Spatial, polarization, and wavelength splitters}
