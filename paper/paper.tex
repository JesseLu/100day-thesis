...
\bibitem{bendsoe} M. P. Bendsoe, O. Sigmund,
...
Increasingly sophisticated optimization strategies for 
    specific nanophotonic devices have been developed;
    ranging from the use of genetic algorithms\cite{lipson},
    level-set methods\cite{yablo}, 
    tweaking the size and shape of specific canonical gemetric shapes\cite{levi,johnson},
    and even utilizing the full parameter space\cite{sigmund1}.
